...
from .models import CorrectionRequest, DecisionRequest, DecisionResult
...
class CorrectionHandler:
    ...
    async def _handle_correction(
        self, correction: CorrectionRequest, task: Optional[Task]
    ) -> (str, Dict[str, Any]):
        """
        处理修正请求
    ...
    async def _handle_task_correction(
        self, correction: CorrectionRequest, task: Task
    ) -> (str, Dict[str, Any]):
        """
        处理任务相关的修正请求
    ...
    async def _handle_general_correction(
        self, correction: CorrectionRequest
    ) -> (str, Dict[str, Any]):
        """
        处理一般修正请求
