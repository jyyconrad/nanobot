...
if hooks_py_path.exists():
    ...
    spec = importlib.util.spec_from_file_location("nanobot.agent.hooks_module", str(hooks_py_path))
...
__all__ = ["HookSystem", "HookResult", "LoggingHooksDecorator", "MainAgentHooks", "MetricsHooksDecorator"]
