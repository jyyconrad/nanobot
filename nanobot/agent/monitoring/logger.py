...
class StructuredLogger:
    ...
    def record_agent_state(self, agent_id: str, state: str, **kwargs):
        ...
        self.log_with_context(
            "INFO", f"Agent state changed: {state}", agent_id=agent_id, **kwargs
        )

    def record_task_progress(
        self, task_id: str, progress: float, task_name: str = None, **kwargs
    ):
        """记录任务进度"""
        self.log_with_context(
            "INFO",
    ...
    def record_tool_use(
        self, tool_name: str, execution_time: float, success: bool = True, **kwargs
    ):
        """记录工具使用"""
